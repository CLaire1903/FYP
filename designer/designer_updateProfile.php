    ...
    <div class="container-fluid p-0">
        ...
        <div class="updateProfileDetail d-flex flex-column justify-content-center mx-5">
            <?php
                ...
                if ($_POST) {
                    ...
                    try {
                        if (empty($_POST['designer_fname']) || empty($_POST['designer_lname']) || empty($_POST['designer_phnumber']) || empty($_POST['designer_gender'])) {
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?designer_email={$designer_email}"); ?>" onsubmit="return validation()" method="post" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-center">
                ...
                <a href='designer_profile.php?designer_email={$designer_email}' class='actionBtn btn mb-3 mx-2'>Back</a>
            </div>
        </form>
    </div>
