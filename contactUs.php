...
<body>
    <div class="container-fluid p-0">
        ...
        <div class="contact d-flex justify-content-evenly mt-5">
            <div class="phone col-3 p-3 border d-flex flex-column">
                <b>Phone Number :</b>
            ...
            <div class="email col-3 p-3 border d-flex flex-column">
                <b>Email :</b>
            ...
            <div class="address col-3 p-3 border d-flex flex-column">
                <b>Address :</b>
                <p class="pt-2 mb-0">Blok B&C, Lot, 5, Seksyen 10, Jalan Bukit, Taman Bukit Mewah, 43000 Kajang, Selangor</p>
            </div>
        </div>
        <div class="feedback d-flex justify-content-center m-5 border rounded-3">
                ...
                <?php
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" onsubmit="return validation()" method="post">
                        ...
                        <div class="button d-grid m-3 d-flex justify-content-center">
                            ...
                            <a href='#' onclick='sendFeedback("$feedback_detail");' class='actionBtn btn btn-lg mb-3 mx-2 d-flex justify-content-center'>Feedback</a>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="map m-5">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7968.796379339112!2d101.79257065449215!3d2.9868617846503436!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cdcb841d3762c7%3A0x4dc97330d731c530!2zTmV3IEVyYSBVbml2ZXJzaXR5IENvbGxlZ2Ug5paw57qq5YWD5a2m6Zmi!5e0!3m2!1sen!2smy!4v1575533854059!5m2!1sen!2smy" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
            </div>
        <?php
        include 'footer.php';
        ?>
...
<script type='text/javascript'>
    function sendFeedback(feedback_detail) {
        if (confirm('Send this feedback?')) {
            window.location = "process_sendFeedback.php?feedback_detail=" + feedback_detail;
        }
    }
</script>
</body>
