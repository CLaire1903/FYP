                ...
                <li class="nav-item">
                    <div class="d-flex">
                        <div class="navIcon mx-2">
                            <a href="admin_profile.php?admin_email={$admin_email}"><img src="../image/icon/profile.png" alt="profile"></a>
                        </div>
                        <div class="navIcon mx-2">
                            <a href="admin_logout.php"><img src="../image/icon/logout.png" alt="Logout"></a>
                        </div>
                    </div>
                </li>
            </ul>
