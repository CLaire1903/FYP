<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid d-flex justify-content-lg-between">
        <div class="storeLogo d-none d-lg-block">
            <a href="summary.php"><img src="../image/logo/mm-logoB.png"></a>
        </div>
                ...
                <li class="nav-item">
                    <div class="d-flex">
                        <div class="navIcon mx-2">
                            <a href="designer_profile.php?designer_email={$designer_email}"><img src="../image/icon/profile.png" alt="profile"></a>
                        </div>
                        <div class="navIcon mx-2">
                            <a href="designer_logout.php"><img src="../image/icon/logout.png" alt="Logout"></a>
                        </div>
                    </div>
                </li>
            </ul>
